...
print("min, max of min-max-normalized:",min(xNormMinMax), ",", max(xNormMinMax))
# What are the largest and smallest values in the z-normalized variable?
print("min, max of z-normalized:",min(xNormZ), ",", max(xNormZ))
# What is the mean in the min-max-normalized variable?
print("Mean of min-max-normalized:", np.mean(xNormMinMax))
# What is the mean in the z-normalized variable?
print("Mean of z-normalized:", np.mean(xNormZ))
...
offset = np.median(x)
spread = np.absolute(x)
xNormL = (x - offset)/spread
print(" The Z-normalized variable:", xNormL)
